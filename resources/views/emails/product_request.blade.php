    ...
    <div style="max-width: 600px; margin: 0 auto; padding: 24px;">
        ...
        <div style="background: #ffffff; padding: 32px; border-left: 1px solid #e2e8f0; border-right: 1px solid #e2e8f0;">
            <p style="margin: 0 0 20px; color: #475569; font-size: 14px;">
                Un cliente está interesado en un producto del catálogo. A continuación los detalles:
            </p>
            ...
            <table style="width: 100%; border-collapse: collapse; margin-bottom: 24px;">
                ...
                <tr>
                    <td style="padding: 12px 16px; background: #f8fafc; border: 1px solid #e2e8f0; font-weight: 600; color: #0f2744;">Producto</td>
                    <td style="padding: 12px 16px; border: 1px solid #e2e8f0; color: #334155; font-weight: 500;">{{ $data['product_name'] }}</td>
                </tr>
            </table>

            <!-- Message Box -->
            <div style="margin-bottom: 24px;">
                <div style="font-weight: 600; color: #0f2744; margin-bottom: 8px; font-size: 14px;">Mensaje del cliente:</div>
            ...
            <div style="text-align: center;">
                <a href="{{ $data['product_url'] }}" style="display: inline-block; background: #3b82f6; color: #ffffff; padding: 12px 28px; border-radius: 8px; text-decoration: none; font-weight: 600; font-size: 14px;">
                    Ver Producto
                </a>
            </div>
        </div>
